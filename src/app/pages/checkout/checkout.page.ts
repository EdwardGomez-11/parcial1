...
import { LoadingService } from 'src/app/shared/services/loadings/loading.service';
import { CartService } from 'src/app/shared/services/localstorage/cart.service';
import { ToastserService } from 'src/app/shared/services/toastser/toastser.service';
...
export class CheckoutPage implements OnInit {
  ...
  constructor(private fb: FormBuilder, private readonly cartS: CartService, private readonly toastS: ToastserService, private router: Router, private readonly loadingS: LoadingService) {
